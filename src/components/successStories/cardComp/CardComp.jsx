...
// import successStories from "../../../api/successStoriesCard.json";
import { successStories } from "../../../api/successStoriesCard";
console.log(successStories); // Ensure it's loading
        ...
        <>
            <div className="successStories-wrapper">
                ...
                {successStories.map((story, index) =>
                    index % 2 === 0 ? (
                        <LeftContentCard key={index} data={story} />
                    ) : (
                        <RightContentCard key={index} data={story} />
                    )
                )}
